package com.lsx.network.interceptor
...
class BusinessErrorInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        try {
            Log.v("http_result", resultString.toString())
            ...
            Log.e("http_result", e.message.toString())
            throw ApiException(e.hashCode(), e.message.toString())
        }
